...
# Trap for signals and errors. For a successful exit, we'll explicitly call pause at the very end of the script.
# This ensures it always waits for input when it completes its magnificent journey.
trap pause INT TERM ERR
...
# Explicitly call pause at the very end to ensure the window stays open
# when the script has completed successfully. This is your personal anchor, darling.
pause
